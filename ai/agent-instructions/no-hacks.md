...
Drop-in system-prompt directive for coding agents. Use when correctness and maintainability matter more than shipping the requested feature on the first attempt.
