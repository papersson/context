...
- Eliminate: "rich/vibrant tapestry", "nestled", "boasts", "serves as", "testament to", "plays a vital role", "underscores", "highlights", "reflects broader", "enduring legacy", "indelible mark", "deeply rooted"
...
- Cut promotional language: "stunning", "groundbreaking", "continues to captivate"

### 2. Eliminate Formulaic Structures
- Remove "In conclusion", "In summary", "Overall" section endings
- Delete "Challenges and Future Prospects" formulaic sections that follow the pattern: "Despite its [positive words]... faces challenges... Despite these challenges..."
...
### 4. Adjust Writing Style
- Use straight quotes (") not curly quotes ("")
- Reduce em dashes (—) significantly; use commas, colons, or split sentences
- Vary sentence structure naturally (don't force patterns)
...
### 5. Remove Collaborative/Meta Elements
- Delete: "I hope this helps", "Let me know", "Would you like...", "Here is a...", "more detailed breakdown"
- Remove knowledge cutoff disclaimers: "as of [date]", "based on available information"
- Cut any chatbot communication artifacts

## Writing Principles

**Be Direct**: Get to the point. Avoid throat-clearing.
