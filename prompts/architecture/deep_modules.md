...
- **Dependency category**: See [Dependency Categories](#dependency-categories) for the four categories
...
4. Dependency strategy (how deps are handled — see [Dependency Categories](#dependency-categories))
5. Trade-offs
